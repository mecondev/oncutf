...
class ConflictResolver:
    ...
    def resolve_conflict(self, old_path: str, new_path: str, strategy: str = "timestamp") -> ConflictResolution:
    ...
    def _execute_operation(self, old_path: str, new_path: str, operation_type: str) -> ConflictResolution:
    ...
    def batch_resolve_conflicts(self, operations: List[Tuple[str, str]], strategy: str = "timestamp") -> List[ConflictResolution]:
