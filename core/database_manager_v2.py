...
class DatabaseManagerV2:
    ...
    def __init__(self, db_path: Optional[str] = None):
        ...
        if db_path:
            ...
            self.db_path = data_dir / "oncutf_data_v2.db"
...
def get_database_manager_v2() -> DatabaseManagerV2:
...
def initialize_database_v2(db_path: Optional[str] = None) -> DatabaseManagerV2:
