...
class PerformanceMonitor:
    ...
    def end_operation(self, operation: str, file_count: int = 0, success: bool = True, error_message: str = "") -> None:
    ...
    def get_stats(self, operation: Optional[str] = None) -> PerformanceStats:
        ...
        if overall_stats.total_operations > 0:
            overall_stats.average_duration = overall_stats.total_duration / overall_stats.total_operations
            overall_stats.average_files_per_operation = overall_stats.total_files / overall_stats.total_operations
            overall_stats.success_rate = (overall_stats.total_operations - overall_stats.error_count) / overall_stats.total_operations
