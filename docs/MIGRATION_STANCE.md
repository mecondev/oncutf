...
1. **Tests pass:** `pytest` (all 592+ tests)
...
- [UI_ARCHITECTURE_PATTERNS.md](UI_ARCHITECTURE_PATTERNS.md) — Mixins vs Behaviors vs Handlers
- [mixin_to_behavior_extraction.md](mixin_to_behavior_extraction.md) — Behavior extraction guide
