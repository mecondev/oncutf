...
class MetadataModule:
    ...
    def _get_file_hash(file_path: str, hash_type: str) -> str:
        """
        Get file hash using the hash cache. If hash is missing, return "missing" without showing dialog.
        ...
        try:
            ...
            # Hash not found in cache - return "missing" without showing dialog
            # The user can manually trigger hash calculation if needed
