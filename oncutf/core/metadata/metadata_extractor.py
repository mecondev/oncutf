...
if TYPE_CHECKING:
    from oncutf.domain.ports import HashServiceProtocol, MetadataServiceProtocol
...
class MetadataExtractor:
    ...
    def _get_metadata_service_from_registry(self) -> MetadataServiceProtocol | None:
        ...
        try:
            ...
            from oncutf.domain.ports import MetadataServiceProtocol as MetaProto
    ...
    def _get_hash_service_from_registry(self) -> HashServiceProtocol | None:
        ...
        try:
            from oncutf.app.ports.service_registry import get_service_registry
            from oncutf.domain.ports import HashServiceProtocol as HashProto
