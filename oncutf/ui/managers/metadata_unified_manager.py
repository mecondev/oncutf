...
class UnifiedMetadataManager(QObject):
    ...
    def _update_caches_after_save(
        ...
        try:
            from oncutf.boot.infra_wiring import get_metadata_cache_instance

            persistent_cache = get_metadata_cache_instance()
            if persistent_cache:
    ...
    def add_custom_field(
        self, field_key: str, field_name: str, category: str, **kwargs: Any
    ) -> bool:
        """Delegate to structured manager."""
