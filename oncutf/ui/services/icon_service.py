...
Usage:
    from oncutf.ui.services.icon_service import load_preview_status_icons, get_menu_icon
...
from oncutf.ui.helpers.icons_loader import ThemeIconLoader
...
def load_preview_status_icons(size: tuple[int, int] | None = None) -> dict[str, "QIcon"]:
    ...
    """
    from oncutf.ui.helpers.icon_cache import load_preview_status_icons as _load
...
def prepare_status_icons(base_dir: str | None = None) -> dict[str, str]:
    ...
    """
    from oncutf.ui.helpers.icon_cache import prepare_status_icons as _prepare
...
def create_colored_icon(
    ...
    """
    from oncutf.ui.helpers.icon_utilities import create_colored_icon as _create
...
def load_metadata_icons(base_dir: str | None = None) -> dict[str, "QPixmap"]:
    ...
    """
    from oncutf.ui.helpers.icons_loader import load_metadata_icons as _load
