...
class CategoryManager:
    ...
    def update_category_availability(self) -> None:
        ...
        file_dates_item.setForeground(QColor())
        ...
        if not selected_files:
            ...
            metadata_item.setForeground(QColor(theme.get_color("text_muted")))
            ...
            if has_hash_data:
                hash_item.setFlags(hash_item.flags() | Qt.ItemIsEnabled)
                hash_item.setForeground(QColor())
            else:
                hash_item.setFlags(hash_item.flags() & ~Qt.ItemIsEnabled)
                hash_item.setForeground(QColor(theme.get_color("text_muted")))
            ...
            if has_metadata_data:
                metadata_item.setFlags(metadata_item.flags() | Qt.ItemIsEnabled)
                metadata_item.setForeground(QColor())
            else:
                metadata_item.setFlags(metadata_item.flags() & ~Qt.ItemIsEnabled)
                metadata_item.setForeground(QColor(theme.get_color("text_muted")))
