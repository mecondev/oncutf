...
class ThemeEngine:
    ...
    def apply_complete_theme(self, app: QApplication, main_window: QMainWindow):
        ...
        try:
            from oncutf.utils.theme_font_generator import generate_dpi_aware_css
    ...
    def _get_complete_stylesheet(self) -> str:
        ...
        return f"""
            ...
            /* Branch images: show chevrons ONLY on the branch adjoining the item */
            QTreeView::branch:has-siblings:!adjoins-item {{
                border-image: none;
                image: none;
            }}

            /* Leaf root line: no icon */
            ...
            /* Remove generic fallbacks to avoid duplicate icons on deeper levels */
