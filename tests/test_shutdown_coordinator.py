...
from core.shutdown_coordinator import ShutdownCoordinator, ShutdownPhase, ShutdownResult
...
class TestShutdownCoordinator:
    ...
    @patch("utils.exiftool_wrapper.ExifToolWrapper")
    ...
    def test_execute_shutdown_success(self, coordinator):
        ...
        with patch("utils.exiftool_wrapper.ExifToolWrapper"):
